# Name: plot2
# Purpose: plot global active power against selected dates(converted to week days)
# and save it to a png file as plot2.png
...
plot_2<- function (dates) {
  
  path = getwd()
  png(filename = paste(path,"/plot2.png", sep=""), width=480, height= 480, units="px", pointsize = 12,     bg="white")
