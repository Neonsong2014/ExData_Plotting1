# Name: plot3
# Purpose: plot sub engery metering against selected dates(converted to week days)
# and save it to a png file as plot3.png
...
plot_3<- function (dates) {
  
  path = getwd()
  png(filename = paste(path,"/plot3.png", sep=""), width=480, height= 480, units="px", pointsize = 12,     bg="white")
